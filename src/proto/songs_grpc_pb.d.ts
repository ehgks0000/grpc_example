...
interface ISongsService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    getSongs: ISongsService_IGetSongs;
...
interface ISongsService_IGetSongs extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, songs_pb.Song> {
...
export interface ISongsServer extends grpc.UntypedServiceImplementation {
    ...
    getSongs: grpc.handleServerStreamingCall<google_protobuf_empty_pb.Empty, songs_pb.Song>;
...
export interface ISongsClient {
    ...
    getSongs(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<songs_pb.Song>;
    getSongs(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<songs_pb.Song>;
...
export class SongsClient extends grpc.Client implements ISongsClient {
    ...
    public getSongs(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<songs_pb.Song>;
    public getSongs(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<songs_pb.Song>;
