...
interface ISongsService_IGetSong
  extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, songs_pb.Song> {
...
interface ISongsService_IAddSongs
  extends grpc.MethodDefinition<songs_pb.Song, google_protobuf_empty_pb.Empty> {
...
interface ISongsService_IGetChat
  extends grpc.MethodDefinition<songs_pb.Song, songs_pb.Comment> {
...
interface ISongsService_ILiveChat
  extends grpc.MethodDefinition<songs_pb.Comment, songs_pb.Comment> {
...
export interface ISongsServer {
  ...
  addSongs: grpc.handleClientStreamingCall<
    songs_pb.Song,
...
export interface ISongsClient {
  getSong(
    ...
    callback: (error: grpc.ServiceError | null, response: songs_pb.Song) => void
  ...
  ): grpc.ClientWritableStream<songs_pb.Song>;
  addSongs(
    metadata: grpc.Metadata,
    callback: (
      error: grpc.ServiceError | null,
  ...
  getChat(
    request: songs_pb.Song,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<songs_pb.Comment>;
  getChat(
    request: songs_pb.Song,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  liveChat(
    options: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<songs_pb.Comment, songs_pb.Comment>;
  liveChat(
    metadata: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<songs_pb.Comment, songs_pb.Comment>;
